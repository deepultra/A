...
function renderGroups() {
    ...
    for (const groupName in teamsData) {
        ...
        standingsTable.innerHTML = `
            ...
            <tbody>
                <tr><td><input type="number" class="rank-input" value="1" min="1" max="4"></td><td>-</td><td>0</td></tr>
                <tr><td><input type="number" class="rank-input" value="2" min="1" max="4"></td><td>-</td><td>0</td></tr>
                <tr><td><input type="number" class="rank-input" value="3" min="1" max="4"></td><td>-</td><td>0</td></tr>
                <tr><td><input type="number" class="rank-input" value="4" min="1" max="4"></td><td>-</td><td>0</td></tr>
            </tbody>
        `;
...
function updateStandingsAndSelections() {
    ...
    groupCards.forEach(card => {
        ...
        teamsWithPoints.forEach((team, index) => {
            ...
            row.innerHTML = `
                <td><input type="number" class="rank-input" value="${index + 1}" min="1" max="4"></td>
                <td><img src="${team.flag}" alt="${team.name}国旗" class="team-flag">${team.name}</td>
                <td>${team.points}</td>
            `;
